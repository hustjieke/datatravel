...
func NewCanal(cfg *Config) (*Canal, error) {
	...
	c.dumpWorkerDone = make(chan struct{})
...
func (c *Canal) WaitDumpWorkerDone() <-chan struct{} {
	return c.dumpWorkerDone
}

func (c *Canal) SetDumpWorkerDone() {
	close(c.dumpWorkerDone)
}
