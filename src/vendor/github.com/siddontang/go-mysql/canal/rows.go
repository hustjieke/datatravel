...
type RowsEvent struct {
	...
	// DataType to tell OnRow handler that the RowsEvent comes from DUMP or BINLOG.
	DataType EventDataType
}

func newRowsEvent(table *schema.Table, action string, rows [][]interface{}, dataType EventDataType) *RowsEvent {
	e := new(RowsEvent)
